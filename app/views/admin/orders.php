            ...
            <table class="table-bordered table-striped table">
                ...
                <?php foreach ($ordersList as $order): ?>
                    <tr>
                        ...
                        <td><a href="/admin/update-order/<?php echo $order->id; ?>" title="Редактировать"><i class="fa fa-edit"></i></a></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="/admin/delete-order/<?php echo $order->id; ?>"class="btn btn-default  btn-success">Удалить</a>
