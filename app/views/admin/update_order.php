                ...
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <select name="status">
                            ...
                            <option value="2" <?php if ($order->status == 2) echo ' selected="selected"'; ?>>Заказ в обработке</option>
                            <option value="4" <?php if ($order->status == 3) echo ' selected="selected"'; ?>>Заказ обработан</option>
                        </select>
                        <br>
                        <br>
