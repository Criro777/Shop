...
(function ($) {
    ...
    $.fn.jRating = function (op) {
        var defaults = {
            ...
            phpPath: '/blog/add-rate/', // path of the php file jRating.php
                ...
                $(this).bind({
                    mouseenter: function (e) {
                        ...
                        if (jDisabled) {
                            ...
                            (this).unbind().addClass('jDisabled');

                        }
                        else {

                            $('.tip1').attr("title", "Поставьте оценку");
                            $('.tip1').tooltip('show');
                        }
                        //
                        ...
                        $.post(opts.phpPath + id, {
                            ...
                            function (data) {
                                ...
                                if (!data.error) {
                                    ...
                                    $('.tooltip-inner').html("Ваша оценка: " + rate);

                                    $('.tooltip').delay(1000);
                                    $('.tooltip').fadeOut(1000);

                                    $(".color").html(data.voted);
                                    jDisabled = true;
